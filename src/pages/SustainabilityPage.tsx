...
>
  ...
  >
    ...
    <motion.p
      ...
      {...motionProps}
    >
      Building a sustainable future through responsible sourcing, environmental stewardship, and
      community empowerment across Africa's agricultural landscape.
    </motion.p>
  </motion.div>
</section>
  ...
  >
    ...
    >
      ...
      <p className="text-lg text-gray-700 leading-relaxed">
        We believe that sustainable agriculture is not just about environmental protection—
        it's about creating lasting value for farmers, communities, and the global food system.
        Our comprehensive approach addresses environmental, social, and economic sustainability
        at every level.
      </p>
    </motion.div>
  </motion.div>
...
<section className="py-16 bg-white">
  ...
  >
    ...
    <div className="grid lg:grid-cols-3 gap-8">
        ...
        <Card className="border-agri-green border-2">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-700">
              We promote farming practices that preserve soil health, conserve water, and protect
              biodiversity while maintaining productive agricultural systems.
            </p>
      ...
      <motion.div variants={fadeInUp} {...motionProps}>
        <Card className="border-agri-green border-2">
          <CardHeader className="text-center">
            <div className="w-16 h-16 bg-agri-green rounded-full mx-auto mb-4 flex items-center justify-center">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-700">
              We invest in the social development of farming communities through education,
              healthcare, and infrastructure improvements that create lasting positive impact.
            </p>
            <ul className="space-y-2 text-sm text-gray-600">
      ...
      <motion.div variants={fadeInRight} {...motionProps}>
        <Card className="border-agri-green border-2">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-700">
              We ensure that sustainable practices are economically viable for farmers, creating
              long-term prosperity and resilience in agricultural communities.
            </p>
            <ul className="space-y-2 text-sm text-gray-600">
...
<section className="py-16 bg-white">
  <div className="container mx-auto px-4">
    ...
    >
      <motion.div variants={fadeInLeft} {...motionProps}>
        <h3 className="text-2xl font-bold text-agri-green mb-6">
          Training & Education
        </h3>
